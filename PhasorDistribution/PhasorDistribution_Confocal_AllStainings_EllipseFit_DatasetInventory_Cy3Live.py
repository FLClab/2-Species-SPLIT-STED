...
f1= os.path.join('U:', os.sep,'adeschenes','2022-11-17_FLIM_Memglow')



f2 = os.path.join('U:', os.sep,'adeschenes',"2023-03-02_LIVE_FLIM","Mito_LIVEOrange_STEDPowerBleach_5to40_3reps_1min_1")


f3 = os.path.join('U:', os.sep,'adeschenes',"2023-03-02_LIVE_FLIM","Tubulin_LIVE560_STEDPowerBleach_5to40_3reps_1min_1")


f4 = os.path.join('U:', os.sep,'adeschenes',"2023-03-17_LiveFLIM_Cy3","Mito_LiveOrange_STEDPowerBleach_5to40_3reps_1min_1")
...
fig.savefig(os.path.join(savefolder,"Centroids_LiveCy3.pdf"),transparent=True, bbox_inches="tight",dpi=900)
