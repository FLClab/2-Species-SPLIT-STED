...
f2 = os.path.join('U:', os.sep,'adeschenes','2022-09-14_Tubulin_SNAP_LIVE610','FLIM')

f3 = os.path.join('U:', os.sep,'adeschenes',"2023-03-02_LIVE_FLIM","Actin_SiR_STEDPowerBleach_5to40_3reps_1min_2")
f4= os.path.join('U:', os.sep,'adeschenes',"2023-03-02_LIVE_FLIM","Tubulin_LIVE610_STEDPowerBleach_5to40_3reps_1min_1")

f5 = os.path.join('U:', os.sep,'adeschenes',"2023-03-02_LIVE_FLIM","Mito_LIVE610_STEDPower_Bleach_5to25_3reps_1min_1")
...
fig.savefig(os.path.join(savefolder,"Centroids_LiveCy5_3.pdf"),transparent=True, bbox_inches="tight",dpi=900)
