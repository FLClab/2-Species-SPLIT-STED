...
# Fixed Cy3 Short Acquisition Template
f6 = os.path.join('U:', os.sep,'adeschenes',"2022-09-23-FLIM_Power_Bleach","Phalloidin594_1")
f1 = os.path.join('U:', os.sep,'adeschenes',"2022-12-09_STEDFLIM_BassoonHomer","Cy3","STEDPower_Bleach_DifferentRegiona","Bassoon_CF594_GluGly_STEDPower_Bleach_1_")
f2 = os.path.join('U:', os.sep,'adeschenes',"2022-12-09_STEDFLIM_BassoonHomer","Cy3","STEDPower_Bleach_DifferentRegiona","Homer_STARORANGE_KCl_STEDPower_Bleach_1_")
f3 = os.path.join('U:', os.sep,'adeschenes',"2022-12-09_STEDFLIM_BassoonHomer","Cy3","STEDPower_Bleach_DifferentRegiona","Bassoon_CF594_Homer_STARORANGE_GluGly_STEDPower_Bleach_1_")
f4 = os.path.join('U:', os.sep,'adeschenes',"2022-12-09_STEDFLIM_BassoonHomer","Cy3","STEDPower_Bleach_DifferentRegiona","Bassoon_CF594_Homer_STARORANGE_GluGly_STEDPower_Bleach_2_")
f5 = os.path.join('U:', os.sep,'adeschenes',"2022-12-15_HomerSTAR580_BassonCF594_FLIM","STEDPower_Bleach_Different_Regions","Basson_CF594_STEDPower_Bleach_1")
f7 = os.path.join('U:', os.sep,'adeschenes',"2022-12-15_HomerSTAR580_BassonCF594_FLIM","STEDPower_Bleach_Different_Regions","Homer_ST580_STEDPower_Bleach_1")

filenames = [f1,f2,f3,f4,f5,f6,f7]

# # Fixed Cy3 Long Acquisition Template
# f1 = os.path.join('U:', os.sep,'adeschenes',"2023-09-06-FLIM_SynapticProteins_LongAcquisition","Bassoon_CF594_STEDPowerBleach_1")
# f2 = os.path.join('U:', os.sep,'adeschenes',"2023-09-06-FLIM_SynapticProteins_LongAcquisition","Homer_STOrange_STEDPowerBleach_1")
# f3 = os.path.join('U:', os.sep,'adeschenes',"2023-10-18_FLIM_ActinSpectrin_Cy3_LongAcquisition","B2Spectrin_CF594_STEDPowerBleach_10to40_1")
# f4 = os.path.join('U:', os.sep,'adeschenes',"2023-10-18_FLIM_ActinSpectrin_Cy3_LongAcquisition","Phalloidin_Alexa594_STEDPowerBleach_10to40_1")
# f5 = os.path.join('U:', os.sep,'adeschenes',"2023-10-31_FLIM_Tubulin_Homer_longacquisitions","AlphaTubulin_CF594_STEDPower_Bleach_10to40_1")
# f6 = os.path.join('U:', os.sep,'adeschenes',"2023-10-31_FLIM_Tubulin_Homer_longacquisitions","Homer1c_STOrange_STEDPower_Bleach_10to40_1")
# filenames = [f1,f2,f3,f4,f5,f6]
# # Fixed Cy3 Medium Acquisition Template
...
# f6 = os.path.join('U:', os.sep,'adeschenes',"2023-12-21_FLIM_MediumAcq_Spectrin_Actin_Bassoon","Phalloidin_AF594_STEDPowerBleach_MediumAcq_1")
# filenames = [f1,f2,f3,f4,f5,f6]
#filenames = [f34,f35,f36,f37,f38,f39,f40,f41,f42,f43,f44,f45,f46,f47]
...
fig.savefig(os.path.join(savefolder,"Centroids_FixedCy3_LongmAcq.pdf"),transparent=True, bbox_inches="tight",dpi=900)
