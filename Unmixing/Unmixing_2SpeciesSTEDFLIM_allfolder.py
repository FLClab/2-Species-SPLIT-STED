...
#f3= os.path.join('U:', os.sep,'adeschenes',"2023-12-21_FLIM_MediumAcq_Spectrin_Actin_Bassoon","Phalloidin_AF594_B2Spectrin_CF594_STEDPowerBleach_MediumAcq_2")
...
img = plt.imshow(np.array([[0,1]]), cmap="cool")
