...
"""
This script generates graphs of the intensity of images used for simulation with added synthetic background. It reads CSV files generated
 by Simulation_NoiseonMixed_Poisson_Intensity.py containing intensities of the foreground and background before and after the addition of background.
 The script groups the intensities by condition such as depletion power and noise type and plots the results. 
