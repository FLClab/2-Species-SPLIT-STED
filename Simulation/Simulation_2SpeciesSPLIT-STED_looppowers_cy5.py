...
Powerslist=[[5,[29,29,30,28,1,1,2,0]],[10,[29,29,30,28,1,1,2,0]],[15,[29,29,30,28,1,1,2,0]],[20,[29,29,30,28,1,1,2,0]]]# PSD95 Bassoon Cy5
...
labels = ['PSD95_AF647 Confocal','PSD95_AF647 STED 5%','PSD95_AF647 STED 10%','PSD95_AF647 STED 15%','Bassoon_ST635P Confocal','Bassoon_ST635P STED 5%','Bassoon_ST635P STED 10%','Bassoon_ST635P STED 15%', 'Mixture']
...
def Simulate3speciesLineControls(STEDPOWER, NUMIM):
    ...
    savefolder = "Simulation_Cy5_{}Percent_3Species_LineControls_PSD95Bassoon".format(STEDPOWER)
