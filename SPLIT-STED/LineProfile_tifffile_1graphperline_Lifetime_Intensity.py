...
plotcolors = ('orange','limegreen', 'orange','limegreen')

#  plot titles
labels=["Intensity","Lifetime"]
...
normch={0:[0],1:[1]}  #normalize each channel independently
...
#
    ...
    for i, line in enumerate(linelist):
        fig, axes = pyplot.subplots(nrows=1, ncols=2, sharex=True,figsize=(3,2))
        ...
        for n,trace in enumerate(traces):
            ...
            axes[rows[n]].plot(xvalues,trace,c=plotcolors[n], label='Line{}'.format(i))
